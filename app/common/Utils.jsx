...
let Utils = (function () {
    ...
    let common = (() => {
        ...
        return {
            closeModalContainer, createModalContainer, scrollTop, renderReactDOM, showImgEditor
        }
    })();
    ...
    return {
        common, pager, _setCurrentPage, _getCurrentPage, showImgLightbox, addr, nProgress
    };
